...
const defaultProps: ScrollBarProps = __DEV__ ? require("./devDefaultProps").default : {};
...
export default class ScrollBar extends React.Component<ScrollBarProps, ScrollBarState> {
	...
	render() {
		...
		const { showHorizontalBar, showVerticalBar, scrollBarStyle, trackStyle, thumbStyle, iconStyle, scrollSpeed, iconNode, children, ...attributes } = this.props;
